...
\usepackage[top=1.23in,left=1in,right=1in,bottom=1.3in,footskip=0.35in]{geometry}
...
\include{defs}
\include{chapters/uds/math_commands}
...
%     \fancyfoot[C]{\thepage} % Centered page number at footer
% }
...
\numberofmembers{4} 
	\chair{Professor Sergey Levine} 
	\othermemberA{Professor Jiantao Jiao}
