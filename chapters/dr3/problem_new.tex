...
%%AK: I changed this a bit. I didn't say that this is building on IUP, but I can add that if the above doesnt seem reasonable
...
%%AK: I am not sure if we can say necessarily that it is bad for supervised learning, but we can say it is bad for TD-learning because of co-adaptation


The supervised and TD solutions are:
\begin{align}
