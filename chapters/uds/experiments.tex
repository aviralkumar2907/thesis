...
For AntMaze, following the setup in \cite{yang2021trail}, we use 10k expert transitions as the labeled data and the entire datasets of {large-play} and {medium-play} as the unlabeled data.
...
\vspace{-0.1cm}
\subsection{Results of Empirical Evaluations}
\label{sec:results}
\vspace{-0.1cm}
