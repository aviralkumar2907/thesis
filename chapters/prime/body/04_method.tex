\section{\primemethodname: Architecting Accelerators via Conservative Surrogates}
\label{sec:method}
%
...
\begin{wrapfigure}{r}{0.47\textwidth}
    ...
    \label{fig:method}
\end{wrapfigure}
\niparagraph{Learning conservative surrogates using logged offline data.}
...
\niparagraph{Incorporating design constraints via infeasible points.}
%
...
\niparagraph{Multi-model optimization and zero-shot generalization.}
%
